...
try {
    ...
    // Send 2FA email using PHP mail() function (simpler, no PHPMailer needed)
    if ($sendEmail) {
        $to = $email;
        $subject = 'Your 2FA Verification Code';
        $message = "Hello {$row['user_firstname']},\n\nYour 2FA verification code is: $twoFA\n\nIt expires in 5 minutes.";
        $headers = "From: crtvshots@crtvshotss.atwebpages.com\r\n";
        $headers .= "Reply-To: crtvshots@crtvshotss.atwebpages.com\r\n";
