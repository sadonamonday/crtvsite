<?php
// admin/reviews_update.php - Update review approval status
...
try {
    ...
    $isApproved = isset($input['is_approved']) ? ($input['is_approved'] ? 1 : 0) : null;
    ...
    $stmt->bindValue(':is_approved', $isApproved, PDO::PARAM_INT);
